...
echo -e  "Tools    : m ilham nr86 $white         " |lolcat
echo -e  "Creadby  : MR.86$white   " |lolcat
echo -e  "Contact  : milhamnr09@gmail.com $white " |lolcat
echo -e  "_____________________________________________________________"
...
do
echo ""
echo -e $b "1.  HACK CCTV DPR/MPR${enda}";
echo -e "============================" | lolcat
...
1.) CCTV Depan Gedung DPR/MPR:

Langsung aja salin link di bawah ini pilih salah satu.......kalau ada yg tdk berfungsi tolong langsung hubungi kami di e-mail
...
☆Jangan salah gunakan rsko tgg sdri☆
